                        ...
                        <div class="row justify-content-center">
                            ...
                            {{-- <div class="col-3">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="/admin?sort=asc">kecil</a></li>
                                        <li><a class="dropdown-item" href="/admin?sort=desc">besar</a></li>
                                    </ul>
                                  </div>
                            </div> --}}
                            <div class="col-3">
                                <form action="/admin" method="get">
                                    <div class="input-group mb-3">
                                         <input type="text" required name="search1"  value="{{ request('search1') }}" class="form-control" placeholder="NIS" aria-label="Recipient's username" aria-describedby="button-addon2">
